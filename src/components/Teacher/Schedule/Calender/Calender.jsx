...
const Calender = () => {
  return (
    <div className="lg:flex lg:h-full lg:flex-col">
      <header className="bg-white border border-b border-gray-200 flex items-center justify-between lg:flex-none px-6 py-4">
          ...
          <div className="isolate grid w-full grid-cols-7 grid-rows-6 gap-px lg:hidden">
            {days.map((day) => (
              <button
                ...
                data-is-current-month={day.isCurrentMonth ? "" : undefined}
                className="flex h-14 flex-col px-3 py-2 not-data-is-current-month:bg-gray-50 not-data-is-selected:not-data-is-current-month:not-data-is-today:text-gray-500 hover:bg-gray-100 focus:z-10 data-is-current-month:bg-white not-data-is-selected:data-is-current-month:not-data-is-today:text-gray-900 data-is-current-month:hover:bg-gray-100 data-is-selected:font-semibold data-is-selected:text-white data-is-today:font-semibold not-data-is-selected:data-is-today:text-indigo-600"
              >
                <time
                  dateTime={day.date}
                  className="ml-auto in-data-is-selected:flex in-data-is-selected:size-6 in-data-is-selected:items-center in-data-is-selected:justify-center in-data-is-selected:rounded-full in-data-is-selected:not-in-data-is-today:bg-gray-900 in-data-is-selected:in-data-is-today:bg-indigo-600"
                >
                  {day.date.split("-").pop().replace(/^0/, "")}
                </time>

          ...
          <div className="grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
              <Input
                ...
                onBlur={handleBlur}
                error={
                  touched.tuition_days_per_week && errors.tuition_days_per_week
                }
              />
            </div>
          ...
          <div className="grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
              <Input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                error={touched.salary_per_month && errors.salary_per_month}
              />
            </div>
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 sm:col-span-3">
              <Input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                error={touched.salary_per_subject && errors.salary_per_subject}
              />
            </div>
